...
export const reportPdfStrings = {
  tr: {
    ...
    professional: {
      ...
      attLow: "Dikkat sürdürme performansında yaş normlarının altında kalma eğilimi gözlenmiştir. İhmal örüntüleri dikkatle değerlendirilmelidir.",
      timOk: "Zamanlama performansı kabul edilebilir düzeydedir.",
      timLow: "Zamanlama performansında hafif düzeyde değişkenlik izlenmiştir. Bu durum bazı görevlerde tepki hızının dalgalanabileceğini düşündürmektedir.",
      ...
      impLow: "Dürtüsellik göstergeleri normal sınırlar içerisinde olmakla birlikte zaman zaman aceleci yanıt örüntüleri gözlenmiştir.",
      hypOk: "Motor kontrol performansı güçlü bulunmuştur.",
      hypLow: "Motor kontrol alanında mükerrer veya yönerge dışı basış göstergeleri izlenmiştir.",
  ...
  en: {
    ...
    professional: {
      ...
      attLow: "Sustained attention tended to fall below age norms. Omission patterns should be reviewed carefully.",
      timOk: "Timing performance was at an acceptable level.",
      timLow: "Mild variability in timing was observed. This may indicate fluctuating response speed in some tasks.",
      impOk: "Impulsivity indicators were within normal limits. Responses to non-target stimuli remained limited.",
      impLow: "Impulsivity indicators were within normal limits, though occasional rushed response patterns were observed.",
      hypOk: "Motor control performance was strong.",
      hypLow: "Indicators of repeated or off-task presses were observed in motor control.",
